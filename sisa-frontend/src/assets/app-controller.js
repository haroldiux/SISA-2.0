    ...
    window.buildOfficialFolderHtml = function(selectedSections, selectedCareerCode) {
      ...
      // 5. PROGRAMA ANALÍTICO (PA) - Exact format of Programa Analitico PROGRAMACION III.docx (2 Balanced Justified Pages)
      if (selectedSections.includes('pa')) {
        const headerComponent = `
          <div style="display: flex; justify-content: space-between; align-items: center; border-bottom: 1.5px solid #000; padding-bottom: 3px; margin-bottom: 10px; font-family: 'Times New Roman', Times, serif;">
        ...
        // PAGE 1: Header, Tabla Técnica, Unidades 1, 2 y 3
        docHtml += `
          <div class="print-page" style="padding: 12mm 15mm 10mm 15mm; font-family: 'Times New Roman', Times, serif; font-size: 8.5pt; background: #fff; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.1); border-radius: 4px; margin-bottom: 20px; text-align: justify;">
            ${headerComponent}

            <div style="text-align: center; font-weight: bold; font-size: 10.5pt; margin-bottom: 8px; letter-spacing: 0.5px;">
              PROGRAMA ANALITICO
            </div>

            <table style="width: 100%; border: 1px solid #000; border-collapse: collapse; text-align: center; font-size: 7pt; margin-bottom: 10px;">
              <thead>
            ...
            <div style="font-weight: bold; font-size: 8.5pt; margin-top: 4px; margin-bottom: 1px;">
              Tema 1: Anatomía de la Entidad y el Objeto
            </div>
            <div style="padding-left: 18px; font-size: 8pt; line-height: 1.35;">
        ...
        // PAGE 2: Header, Unidad 4, Bibliografía Principal y Complementaria
        docHtml += `
          <div class="print-page" style="padding: 12mm 15mm 10mm 15mm; font-family: 'Times New Roman', Times, serif; font-size: 8.5pt; background: #fff; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.1); border-radius: 4px; margin-bottom: 20px; text-align: justify;">
            ${headerComponent}

            <!-- UNIDAD 4 -->
            <div style="font-weight: bold; font-size: 9pt; margin-top: 4px; margin-bottom: 2px;">
            ...
            <div style="padding-left: 18px; font-size: 8pt; line-height: 1.35; margin-bottom: 14px;">
            ...
            <div style="font-weight: bold; font-size: 9pt; margin-top: 10px; margin-bottom: 4px; border-bottom: 1px solid #ccc; padding-bottom: 2px;">
              BIBLIOGRAFIA. -
            </div>
            <div style="padding-left: 18px; font-size: 8pt; line-height: 1.5; margin-bottom: 14px;">
            ...
            <div style="padding-left: 18px; font-size: 8pt; line-height: 1.5;">
            ...
            <div style="text-align: center; font-size: 8pt; margin-top: 18px;">2</div>
          </div>
        `;
      }
